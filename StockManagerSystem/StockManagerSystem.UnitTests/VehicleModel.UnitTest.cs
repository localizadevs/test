...
namespace StockManagerSystem.UnitTest
{
    ...
    public class VehicleModelTest
    {
        ...
        {
            VehicleModel vehicleModel = new VehicleModel{ Name = "fusca", Capacity = 100, Quantity = 10, DefaultPrice = 10.1 };
        ...
        {
            VehicleModel vehicleModel = new VehicleModel { Name = "fusca", Capacity = 10, Quantity = 0, DefaultPrice = 10.1 };
        ...
        {
            VehicleModel vehicleModel = new VehicleModel { Name = "fusca", Capacity = 50, Quantity = 40, DefaultPrice = 10.1 };
        ...
        {
            VehicleModel vehicleModel = new VehicleModel { Name = "fusca", Capacity = 40, Quantity = 40, DefaultPrice = 10.1 };
        ...
        {
            VehicleModel vehicleModel = new VehicleModel { Name = "fusca", Capacity = 40, Quantity = 1, DefaultPrice = 10.1 };
